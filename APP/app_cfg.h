...
#define  APP_CFG_TASK_ADC_STK_SIZE                      256u
...
#define  APP_CFG_TASK_ADC_STK_SIZE_PCT_FULL             90u
#define  APP_CFG_TASK_ADC_STK_SIZE_LIMIT           (APP_CFG_TASK_ADC_STK_SIZE  * (100u - APP_CFG_TASK_ADC_STK_SIZE_PCT_FULL))  / 100u
