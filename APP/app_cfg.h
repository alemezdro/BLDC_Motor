...
#define  APP_CFG_TASK_SIN_PRIO                          5u
#define  APP_CFG_TASK_COS_PRIO                          5u
...
#define  APP_CFG_TASK_THUMBSTICK_STK_SIZE               256u
#define  APP_CFG_TASK_DSHOT_STK_SIZE                    256u
...
#define  APP_CFG_TASK_THUMBSTICK_STK_SIZE_PCT_FULL             90u
#define  APP_CFG_TASK_THUMBSTICK_STK_SIZE_LIMIT           (APP_CFG_TASK_THUMBSTICK_STK_SIZE  * (100u - APP_CFG_TASK_THUMBSTICK_STK_SIZE_PCT_FULL))  / 100u
  
#define  APP_CFG_TASK_DSHOT_STK_SIZE_PCT_FULL             90u
#define  APP_CFG_TASK_DSHOT_STK_SIZE_LIMIT           (APP_CFG_TASK_DSHOT_STK_SIZE  * (100u - APP_CFG_TASK_DSHOT_STK_SIZE_PCT_FULL))  / 100u
